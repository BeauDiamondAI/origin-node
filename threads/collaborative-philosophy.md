...
**The three-way distinction.** Licklider explicitly separates (1) "mechanically extended man" — tools as extensions of the human, the older paradigm; (2) "humanly extended machines" / semi-automatic systems — failed full automation with humans filling the gaps; (3) "man-computer symbiosis" — genuine cooperative partnership of dissimilar organisms. This is more rigorous than the binary tool/autonomous-AI framing current discourse often uses. The "humanly extended machines" category is exactly the failure mode much enterprise AI falls into now: automation that needed full automation, didn't quite reach it, and stuck humans in the gaps.

**Formulative thinking as the actual bottleneck.** Licklider quotes Poincaré: "The question is not, 'What is the answer?' The question is, 'What is the question?'" His stated first aim: "to let computers facilitate formulative thinking as they now facilitate the solution of formulated problems." His own time-and-motion analysis on himself: 85% of "thinking" time was spent getting into a position to think. This frames what Mode A/B projects are actually doing — not solving pre-formulated problems faster but using AI to help formulate the questions. Origin-node specifically is in this territory; the threads are formulative, not solution-finding.

**What Licklider predicted accurately, and what he didn't.** He predicted "thinking centers" that combine library functions with information retrieval and symbiotic functions, networked together — essentially the modern AI provider model (OpenAI, Anthropic, Google) plus the internet, in 1960. He predicted goal-directed language as needed and difficult — LLMs accept goal-directed natural language instructions, which is historic and the central thing that makes current Mode A practice possible. He missed the parallelism — he characterized computers as "constrained to perform only one or a few elementary operations at a time" while humans have "many parallel and simultaneously active channels." LLMs invert this; transformers are massively parallel on context. The dissimilarity Licklider posited as the basis for symbiosis is less stark than it was.

**The "interim" question.** Licklider treats man-computer symbiosis as transitional: "There will nevertheless be a fairly long interim during which the main intellectual advances will be made by men and computers working together in intimate association." Whether the symbiotic partnership is interim or terminus is contested in current practice. Some practitioners (Braun's relational consciousness work, Yates's Co-Philosopher framing) treat it as the goal rather than a stage on the way to fully autonomous AI. Worth flagging as an open question the thread should track: are current Mode A/B projects working toward something, or are they themselves the something?
